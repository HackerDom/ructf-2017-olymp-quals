...
class TestCheck(unittest.TestCase):
	...
	def test_bwt_revert(self):
		self.assertEqual(check_drapo.bwt_revert('L', 1), 'L')

	# 'LQ' and 'LQR' are not correct bwt result

	def test_bwt_revert3(self):
		result = check_drapo.bwt_revert('LQRH', 4)
		rotations = check_drapo.string_rotations('RQLH')
		self.assertTrue(result in rotations)

	def test_bwt(self):
		self.assertEqual(check_drapo.bwt('RQLH', 4), 'LQRH')

	def test_check_partial_transform_L(self):
		bytes = ('L\x00' + 71*'\x01').encode('ascii')
		self.assertTrue(check_drapo.check_partial_transform(bytes))
	...
	def test_check_partial_transform_RQHK(self):
		...
		self.assertFalse(check_drapo.check_partial_transform(bytes))

	def test_check_partial_transform_QQ(self):
		bytes = ('QQ\x00' + 70*'\x02').encode('ascii')
		self.assertFalse(check_drapo.check_partial_transform(bytes))

	def test_check_partial_transform_empty(self):
		bytes = ''.encode('ascii')
		self.assertFalse(check_drapo.check_partial_transform(bytes))

	def test_check_partial_transform_byte_overflow(self):
		answer = base64.b64decode("")
		result = check_drapo.check_partial_transform(answer)
